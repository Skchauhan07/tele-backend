...
public byte[] generatePdfFile(Prescription prescription) {
    try (ByteArrayOutputStream stream = new ByteArrayOutputStream();
        ...
        content.showText("Medical Findings:");
        content.newLineAtOffset(0, -leading);
        content.setFont(font, fontSize - 2);
        content.showText(prescription.getMedicalFinding());
        content.setFont(font, fontSize);
        content.newLineAtOffset(0, -leading*2);
        content.showText("Medicine Details:");
        content.newLineAtOffset(0, -leading);
        content.showText("1. Medicine Name: " + prescription.getMedicineName());
        content.newLineAtOffset(0, -leading);
        content.showText("2. Dosage: " + prescription.getDosage());
        content.newLineAtOffset(0, -leading);
        content.showText("3. Duration: " + prescription.getDuration());
